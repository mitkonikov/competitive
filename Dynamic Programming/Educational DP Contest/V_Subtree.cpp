...
//   so that any black vertex can be reached from any other black vertex
//   by passing through only black vertices.
//   You are given a positive integer M. For each v (1 <= v <= N), answer the following question:
//     - Assuming that Vertex v has to be black, 
//       find the number of ways in which the vertices can be painted, modulo M.
//   
